...
public:
    ...
    virtual arma::mat    center_box(arma::mat const &x)        = 0;
    virtual arma::mat    wrap_coordinates(arma::mat const &x)  = 0;
    virtual arma::rowvec wrap_rowvector(arma::rowvec const &x) = 0;
    virtual arma::vec    wrap_vector(arma::vec const &x)       = 0;
