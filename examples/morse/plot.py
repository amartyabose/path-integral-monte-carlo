...
data_pimc = np.loadtxt('pimc.beta1.G6.props15/phasespace/nd.0.configs.xyz', usecols=(2,))
data_wigner = np.loadtxt('wigner.beta1.G6.props15/phasespace/nd.0.configs.xyz', usecols=(0,2,3))
